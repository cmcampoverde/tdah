...
export class GameComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.gameService
      ...
      .subscribe(
        (res: HttpResponse<IGame[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInGames(): void {
    this.eventSubscriber = this.eventManager.subscribe('gameListModification', () => this.loadPage());
  }
