...
export class ScoreComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.scoreService
      ...
      .subscribe(
        (res: HttpResponse<IScore[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IScore[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
