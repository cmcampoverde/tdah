...
import com.titulacion.tdah.config.Constants;
...
import com.titulacion.tdah.web.rest.errors.EmailAlreadyUsedException;
import com.titulacion.tdah.web.rest.errors.LoginAlreadyUsedException;
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            if (newUser.isDoctor())
                ...
                mailService.sendCreationEmailChildren(newUser);
